...
# Set all versions
TOXIC_VERSION := Toxic-OS$(TOXIC_BUILD)-v$(ANDROID_VERSION)_$(shell date +%Y%m%d)_$(TOXIC_VERSION_NUMBER)
TOXIC_MOD_VERSION := Toxic-OS$(TOXIC_BUILD)-v$(ANDROID_VERSION)_$(shell date +%Y%m%d)_$(TOXIC_VERSION_NUMBER)
