...
# Set all versions
TOXIC_VERSION := TOXIC_$(TOXIC_BUILD)_$(ANDROID_VERSION)_$(shell date +%Y%m%d)_$(TOXIC_VERSION_NUMBER)
TOXIC_MOD_VERSION := TOXIC_$(TOXIC_BUILD)_$(ANDROID_VERSION)_$(shell date +%Y%m%d)_$(TOXIC_VERSION_NUMBER)
